...
t[#t+1] = LoadFont("_wendy small")..{
	...
	GainFocusCommand=function(self) self:stoptweening():zoom(0.38):accelerate(0.1):diffuse(PlayerColor(PLAYER_2)):glow(1,1,1,0.5):decelerate(0.05):glow(1,1,1,0) end,
	LoseFocusCommand=function(self) self:stoptweening():zoom(0.35):accelerate(0.1):diffuse(ThemePrefs.Get("RainbowMode") and {1,1,1,1} or color("#888888")):glow(1,1,1,0) end
}
